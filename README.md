...
- neither store an encrypted value that can be decrypted with a key, since this has the same problem as a plaintext string if compromised. (hashing and encryption are different things)
